...
/**
 * Beam Ã¤r den virtuella processen fÃ¶r bommen utan kula. FÃ¶ljande beskrivning av processen har en insignal, en utsignal och ett tillstÃ¥nd.
 * <pre>
 * TillstÃ¥ndsvektor:
 *
 *                   Ã§(t) = | phi(t) |    (Vinkeln pÃ¥ bommen)
 *
 * TillstÃ¥ndsekvationer:
 *
 *                  dÃ§/dt = | 0  0  0  |*Ã§(t) + |  kPhi  |*u(t)     ( kPhi=4.4 )
 *
 *
 *                   y(t) = | 0  0  1  |        |phi(t)|
 *
 *
 * Definitionen pÃ¥ in- och utgÃ¥ngar Ã¤r:
 *
 * IngÃ¥ng 0: Styrsignal till processen.
 * UtgÃ¥ng 0: Vinkeln pÃ¥ bommen.
  * </pre>
 * Det finns Ã¤ven en animering implementerad till denna virtuella process. FÃ¶r att visa animering anvÃ¤nd metoden getAnimationPanel i VirtualProcess och lÃ¤gg in panel i ett fÃ¶nster (se exempel 2 i <A HREF="../SimEnvironment/VirtualProcess.html">VirtualProcess</A>). Uppdateringen av animeringen sker automatiskt med en animeringstrÃ¥d i Vir
tualProcess.<P>
 *
