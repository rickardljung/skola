function [ x, y ] = leastSquares()
%rekostruerar de punkter som saknas med hjälp av "least squares"
...
% de 9 x-värden som saknas för övre bågen. Kopierade direkt från matrisen
% A.
